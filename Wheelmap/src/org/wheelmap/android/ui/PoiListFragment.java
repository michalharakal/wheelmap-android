...
public class PoiListFragment extends ListFragment implements OnRefreshListener, Receiver, LoaderCallbacks<Cursor> {
  ...
  public void onReceiveResult(int resultCode, Bundle resultData) {
    switch (resultCode) {
      case MyLocationManager.WHAT_LOCATION_MANAGER_UPDATE: {
        mLocation = (Location) resultData.getParcelable(MyLocationManager.EXTRA_LOCATION_MANAGER_LOCATION);
        break;
      }
    }
  }
  ...
  public Loader<Cursor> onCreateLoader(int id, Bundle args) {
    ...
    return new CursorLoader(getActivity(), uri, Wheelmap.POIs.PROJECTION,
      QueriesBuilderHelper.userSettingsFilter(getActivity().getApplicationContext()), createWhereValues(), "");
  }
