/*
 * Copyright (C) 2011 Michal Harakal and Michael Kroez Licensed under the Apache
...
public class POIsListActivity extends FragmentActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(android.R.id.content, new PoiListFragment(),
                            PoiListFragment.TAG).commit();
        }
    }
    ...
    private void updateRefreshStatus() {
        ...
        PoiListFragment listFragment = (PoiListFragment) getSupportFragmentManager()
                .findFragmentByTag(PoiListFragment.TAG);
